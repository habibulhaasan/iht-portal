...
// ─────────────────────────────────────────────────────────────
// Slug ↔ BBS division id (members store slugs; bd-data uses numeric ids)
// ─────────────────────────────────────────────────────────────

export const DIVISION_ID_BY_SLUG = {
  barishal: '1',
  chattogram: '2',
  dhaka: '3',
  khulna: '4',
...
export const DIVISION_SLUG_BY_ID = {
  '1': 'barishal',
  '2': 'chattogram',
  '3': 'dhaka',
  '4': 'khulna',
...
/** Lookup geographic division row by member-facing slug. */
export function getBdDivisionBySlug(slug) {
  return BD_DIVISIONS.find((d) => d.id === DIVISION_ID_BY_SLUG[slug])
}

/** Districts for a member-facing division slug. */
export function getDistrictsByDivisionSlug(slug) {
  return getDistrictsByDivision(DIVISION_ID_BY_SLUG[slug])
}
 ...
 */
export function getLocationLabel(upazilaId, locale = "en") {
...
export const DIVISION_SLUG_MAP = {
  barishal: "1",
  chattogram: "2",
  dhaka: "3",
  khulna: "4",
